                            ...
                            <div class="form-group row">
                                ...
                                <select id="students" name="students[]" multiple class="form-control">
                                    @foreach($students as $student)
                                        @if (old('student')==$student->id || in_array($student->id, $selected_students))
                            ...
                            <div class="form-group row">
                                ...
                                <select id="teachers" name="teachers[]" multiple class="form-control">
                                    @foreach($teachers as $teacher)
                                        @if (old('teacher')==$teacher->id || in_array($teacher->id, $selected_teachers))
                        ...
                        <div class="col-8">
                            <div class="form-group row">
                                ...
                                <input id="subject" type="text"
                                       ...
                                       name="subject" value="{{ old('subject', $message->subject) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <select id="body" name="body" class="form-control">
                                    @foreach($body_list as $body)
                                        @if ((old('body')== $message->body)||($body== $message->body))
